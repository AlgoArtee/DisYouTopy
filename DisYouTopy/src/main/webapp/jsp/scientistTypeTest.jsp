		...
		<article class="content">
			...
			<div id="mainDisplay">
				...
				<div class="titleBar">
					...
					<div class="titleText">
						<ul>
							<h2>Discover your scientific Self!</h2>
							<ul>
								<ul>
				...
				<form>
					<div class="grid">
						...
						<div class="sectionWrapper">
							...
							<div class="sections">
								<input type="radio" name="activity" value="eating" id="eating"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="eating"> <img src="../img/sciquiz/eating.jpg"
									alt="yummy food">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="activity" value="drinking"
									id="drinking" class="input-hidden" onchange="getAnswers()" /> <label
									for="drinking"> <img src="../img/sciquiz/drinking.jpg"
									alt="drinking cocktails">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="activity" value="painting"
									id="painting" class="input-hidden" onchange="getAnswers()" /> <label
									for="painting"> <img src="../img/sciquiz/painting.jpg"
									alt="painting a picture">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="activity" value="picknicking"
									class="input-hidden" id="picknicking" onchange="getAnswers()" />
								<label for="picknicking"> <img
									src="../img/sciquiz/picknicking.jpg" alt="picknick">
								</label>
							</div>
						...
						<div class="sectionWrapper">
							...
							<div class="sections">
								<input type="radio" name="color" value="brown" id="brown"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="brown"> <img src="../img/sciquiz/brown.jpg"
									alt="cityscape">
								</label>
							</div>
							...
							<div class="sections">
								<input type="radio" name="color" value="red" id="red"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="red"> <img src="../img/sciquiz/red.jpg"
									alt="mountain">
								</label>
							</div>
							...
							<div class="sections">
								<input type="radio" name="color" value="white" id="white"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="white"> <img src="../img/sciquiz/white.jpg"
									alt="beach">
								</label>
							</div>
							...
							<div class="sections">
								<input type="radio" name="color" value="green" id="green"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="green"> <img src="../img/sciquiz/green.jpg"
									alt="desert">
								</label>
							</div>
						</div>
					...
					<div class="grid">
						...
						<div class="sectionWrapper">
							...
							<div class="sections">
								<input type="radio" name="location" value="restaurant"
									id="restaurant" class="input-hidden" onchange="getAnswers()" />
								<label for="restaurant"> <img
									src="../img/sciquiz/restaurant.jpg" alt="restaurant">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="location" value="bar" id="bar"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="bar"> <img src="../img/sciquiz/bar.jpg" alt="bar">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="location" value="laboratory"
									id="laboratory" class="input-hidden" onchange="getAnswers()" />
								<label for="laboratory"> <img
									src="../img/sciquiz/laboratory.jpg" alt="laboratory">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="location" value="park" id="park"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="park"> <img src="../img/sciquiz/park.jpg"
									alt="park">
								</label>
							</div>
						</div>
					...
					<div class="grid">
						...
						<div class="sectionWrapper">
							...
							<div class="sections">
								<input type="radio" name="feeling" value="pleased" id="pleased"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="pleased"> <img src="../img/sciquiz/pleased.png"
									alt="pleased">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="feeling" value="happy" id="happy"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="happy"> <img src="../img/sciquiz/happy.png"
									alt="happy">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="feeling" value="strange" id="strange"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="strange"> <img src="../img/sciquiz/strange.png"
									alt="strange">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="feeling" value="complicated"
									id="complicated" class="input-hidden" onchange="getAnswers()" />
								<label for="complicated"> <img
									src="../img/sciquiz/complicated.png" alt="complicated">
								</label>
							</div>
						</div>
					</div>
						...
						<div class="sectionWrapper">
							...
							<div class="sections">
								<input type="radio" name="animal" value="dog" id="dog"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="dog"> <img src="../img/sciquiz/dog.jpg" alt="dog">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="animal" value="sloth" id="sloth"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="sloth"> <img src="../img/sciquiz/sloth.jpg"
									alt="sloth">
								</label>
							</div>
							...
							<div class="sections">
								<input type="radio" name="animal" value="cat" id="cat"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="cat"> <img src="../img/sciquiz/cat.jpg" alt="cat">
								</label>
							</div>

							<div class="sections">
								<input type="radio" name="animal" value="octopus" id="octopus"
									class="input-hidden" onchange="getAnswers()" /> <label
									for="octopus"> <img src="../img/sciquiz/octopus.jpg"
									alt="octopus">
								</label>
							</div>
						</div>
