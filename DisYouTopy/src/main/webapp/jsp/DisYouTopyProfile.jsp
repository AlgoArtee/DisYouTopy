...
<body>
	...
	<div class="wrapper">
		...
		<article class="content">
			...
			<div class="articlet">
				<div id="forum" class="articletsImg">
					<a href="jsp/DYTforumMIG.jsp"></a>
				</div>

				<br> <br> <br>
				<p class="articletTitle">Madly in Glove Forum</p>
				<br> <br> <br> The World is Your Laboratory! <br>
				<br> <br>The DIY community is yet very dispersed,
				specialized and geekingly enigmatic. This Site aims to bring all
				Cyberpunk dreams together and commonly count the Electric Sheep! <br>
				<br> Visit our Guest Forum! <a href="DYTforumMIG.jsp">Madly
					in Glove</a>

			</div>

			<div class="articlet middle">
				<div id="openProjects" class="articletsImg">
					<a href="openprojects.jsp"></a>
				</div>

				<br> <br>
				<p class="articletTitle">Dive in the Ocean of Open Science
					Projects</p>
				<br> <br> <br> Welcome to the future of your
				existence! <br> <br> Join this Virtual Journey down the
				spirals of DNA, under diode lights and through binary forests.
				Activate your sciency genes - and navigate through our vast
				informational databases on genomes, biohacking experiments, RasPi
				projects and other various stuff to a DIY hearts delight. In "Open
				Projects" you'll find Step by Step tutorials, made with our
				innovative "Easy or Comment" formula. <a href="openprojects.jsp">Read
					more ...</a>

			</div>

			<div class="articlet">
				<div id="signInUp" class="articletsImg">
					<a href="../html/signUp.html"></a>
				</div>

				<br> <br>
				<p class="articletTitle">Sign Up for Your own Virtual Lab Space!</p>
				<br> <br> <br> Want to dive deeper? <br> <br>
				Sign In to get the most comprehensive Profile of your inner
				workings! Our bioinformatics Machine Learning algorithms crawl daily
				through hundreds of biological databases and provide deep insights
				to the data you choose to upload. Quantum entangle with the next
		...
		<div class="history">
			<div class=sideText>
				<a href="openprojects.jsp"> <i class="fa-solid fa-book-open">
						<br> <br> History
				</i>
				</a>
			</div>
	...
	<!-- JavaScript section -->
	<script
		src='https://rawcdn.githack.com/akzhy/Vara/c55a1b40c15b808cdd4a047de95c905094be87db/src/vara.min.js'></script>
	<script
