...
<!-- CSS section -->
	<link rel="stylesheet" type="text/css" rel="noopener" href="css/disyougallery.css">
...
<body>
	...
	<div class="wrapper">
		...
		<article class="content">
			...
			<div id="mainDisplay">
				...
				<div class="acc-wraper">
				  <div class="accordion">
				    <div>		    	
				    	<div class="overlay"><a href="jsp/inConstruction.jsp">Our Biological Databases Reviews</a></div>
				    	<img src="img/disyougallery/bioinformatics_databases.png" alt="">
				    </div>
				    
				    <div>
				    	<div class="overlay"><a href="jsp/inConstruction.jsp">News And Discoveries</a></div>
						<img src="img/disyougallery/chem_lab.png" alt="">
				    </div>
				    
				    <div>
				    	<div class="overlay"><a href="jsp/openprojects.jsp">Experiments</a></div>
						<img src="img/disyougallery/cold_experiments.png" alt="">
				    </div>
				    
				    <div>
				    	<div class="overlay"><a href="jsp/inConstruction.jsp">Data Safty In The DIY Age</a></div>
				      	<img src="img/disyougallery/data_safety.png" alt="">
				    </div>
				    <div>
				    	<div class="overlay"><a href="jsp/openprojects.jsp">Begin A How To Journey!</a></div>
						<img src="img/disyougallery/howto.png" alt="">
				    </div>
				    <div>
				    	<div class="overlay"><a href="jsp/inConstruction.jsp">How To Build Your Own LAB!</a></div>
						<img src="img/disyougallery/lab_01.png" alt="">
				    </div>
				    <div>
				    	<div class="overlay"><a href="jsp/inConstruction.jsp">Through The Cooking Glass</a></div>
						<img src="img/disyougallery/lab_glassware.png" alt="">
				    </div>
				    <div>
				    	<div class="overlay"><a href="jsp/inConstruction.jsp">Essential Literature for DIY Science</a></div>
						<img src="img/disyougallery/literature_resources.png" alt="">
				    </div>
				    <div>
				    	<div class="overlay"><a href="html/signUp.html">Sign Up! :)</a></div>
						<img src="img/disyougallery/locks.png" alt="">
				    </div>
				    <div>
				    	<div class="overlay"><a href="jsp/inConstruction.jsp">Medical Biotech News</a></div>
						<img src="img/disyougallery/medical_biotech.png" alt="">
				    </div>
				    <div>
				    	<div class="overlay"><a href="jsp/inConstruction.jsp">The Microscopic World</a></div>
			...
			<a href="jsp/DYTforumMIG.jsp">
				<div id="forum" class="articletsImg"></div></a>
					
				<br> <br>  <br>
				<p class="articletTitle"> Madly in Glove Forum</p>
				<br> <br>
				The World is Your Laboratory! <br> <br> 
			...
			<a href="jsp/openprojects.jsp">
				...
				through binary forests. In "Open Projects" you'll find Step by Step tutorials, made
				with our innovative "Easy or Comment" formula. <a
					href="html/openprojects.html">Read more ...</a>

			</div>

			<div class="articlet">
			<a href="jsp/signUp.html"><div id="signInUp" class="articletsImg"></div></a>
		...
		<div class="forum"> <div class=sideText>  <a href="jsp/DYTforumMIG.jsp"> <i class="fa-solid fa-comments"> <br> <br> Forum</i> </a> </div></div>

		<div class="catshop"> <div class=sideText> <a href="jsp/inConstruction.jsp"> <i class="fa-solid fa-cat"> <br> <br> Catshop</i> </a> </div></div>
		
		<div class="shop"> <div class=sideText> <a href="jsp/inConstruction.jsp"> <i class="fa-solid fa-cart-shopping"> <br> <br> Shop</i> </a> </div></div>
		
		<div class="experiment_of_the_day">
			<br> <br>
			<div class=sideText> <a href="jsp/openprojects.jsp"> <i class="fa-solid fa-flask"> <br> <br> Experiment of the Day</i> </a> </div>
		</div>
		
		<div class="history"> <div class=sideText> <a href="jsp/inConstruction.jsp"> <i class="fa-solid fa-book-open"> <br> <br> History </i> </a> </div></div>
